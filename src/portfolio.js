...
import Pradyuman from "./assets/Resume/Pradyuman.pdf";
...
const greeting = {
  username: "Pradyuman maran",
  title: "Hi all, I'm Pradyuman maran",
  subTitle: emoji(
  ...
  resumeLink: Pradyuman, // Set to empty to hide the button
...
const socialMediaLinks = {
  github: "https://github.com/Pradyumanmaran",
  linkedin: "https://www.linkedin.com/in/pradyuman-maran-631b4b19a/",
  gmail: "pradyumanmaran@gmail.com",
  gitlab: "https://gitlab.com/pradyumanmaran",
  facebook: "https://www.facebook.com/pradyumanmaran",
  medium: "https://medium.com/@pradyumanmaran",
  stackoverflow: "https://stackoverflow.com/users/22465199/pradyuman-maran",
...
const skillsSection = {
  ...
  skills: [
    emoji(
      "⚡ Develop highly interactive Front end / User Interfaces for your web e applications"
    ),
...
const educationInfo = {
  ...
  schools: [
    {
      schoolName: "K.P.R Institute of Engineering and Technology",
  ...
  experience: [
    {
      ...
      descBullets: [
        "was incharge of monitoring the quality and execution of materials thereby increasing the efiiciency by 50%"
      ]
    },
    {
  ...
  projects: [
    {
      ...
      projectName: "Calculator with dual theme mode (Dark,theme)",
      projectDesc: "Offers both dark and light themes for user preference.",
      footerLink: [
        {
          name: "Visit Website",
          url: "https://pradyumanmaran.github.io/Calculator1/"
        }
    ...
    },
    {
      ...
      projectName: "Weather",
      projectDesc: "search tells you weather of the city you type",
      footerLink: [
        {
          name: "Visit Website",
...
const contactInfo = {
  ...
  number: "+91-8903923909",
  email_address: "pradyumanmaran@gmail.com"
};
